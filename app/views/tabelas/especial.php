...
<!-- BREADCRUMBS -->
<ol class="breadcrumb col-md-7 offset1 margin-less">
    <li>Você está em:</li>
...
<!--end banner-->
<div id="wrapper" class="container-fluid page-break bloco-up">
            ...
            <div class="page-break">
                <div class="bloco-plano row-fluid">
                    <div class="title col-md-10">
                        ...
                        <h3 class="titulo-unimed titulo-grande col-md-3"><?= $t->operadora ?></h3>
                    </div>
