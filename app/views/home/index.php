...
<body>
    <div class="container-fluid">
        <img class="temp" src="img/temp.png" alt="temporario">
        <div class="row-fluid">
            <div id="topo" class="col-md-10 offset1">
                <h1 id="logo" class="col-md-2">Displan</h1>
        ...
        <div id="myCarousel" class="carousel slide row-fluid">
            <div class="carousel-inner">
                ...
                <img class="span12 banner" src="img/banner.jpg" alt="imagem do bannner 1" />
            </div>
            <div class="item">
                <img class="span12 banner" src="img/banner2.jpg" alt="imagem do banner 2" />
            </div>
            <div class="item">
                <img class="span12 banner" src="img/banner3.jpg" alt="imagem do banner 3" />
            </div>
        </div>
    </div>
    ...
    <div id="wrapper" class="container-fluid">
        <div class="row-fluid">
            <div class="title col-md-10 offset1">
                <h3 class="titulo-grande col-md-3">Lorem Ipsum</h3>
            </div>
        </div>
        <div class="row-fluid">
            <div class="content col-md-10 offset1">
                <div class="border-right inside col-md-4">
                    <h5 class="titulo-medio">Planos individuais</h5>
                    <img class="col-md-11" src="img/individuais.png" alt="individuais" title="Planos Individuais">
                </div>
                <div class="border-right inside col-md-4">
                    <h5 class="titulo-medio">Planos empresriais</h5>
                    <img class="col-md-11" src="img/empresas.png" alt="empresas" title="Planos Individuais">
                </div>
                <div class="inside col-md-4">
                    <h5 class="titulo-medio">Planos para profissionais</h5>
                    <img class="col-md-11" src="img/profissionais.png" alt="profissionais" title="Planos Individuais">
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="footer" class="container-fluid">
            <div class="row-fluid">
                <div id="onde-estamos" class="col-md-4">
                    <h4 class="borda-h4">
                    <span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> ONDE ESTAMOS</h4>
            ...
            <div class="row-fluid">
                <div class="col-md-10 offset1">
                    ...
                    <div id="by" class="col-md-2">
                        ...
                        <img src="img/mercurios.png" alt="mercurios" title="Mercurios">
                    </div>
                </div>
            </div>
        </div>
